<template>
    <div class="p-1">
        <div class="form-group mt-1">
            <router-link :to="{name: 'products_brand_index'}" class="btn btn-dark btn-sm" title="Назад">{{ $t('default.back') }}</router-link>
        </div>
    </div>
    <div v-if="preloader">
...
export default {
    ...
    methods: {
        saveForm(e) {
            ...
            axios.post('/api/v1/products_brands/store', newModel)
                .then(function (resp) {
