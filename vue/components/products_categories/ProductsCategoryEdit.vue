<template>
    <div class="p-1">
        <div class="form-group mt-1">
            <router-link :to="{name: 'products_category_index'}" class="btn btn-dark btn-sm" title="Назад">{{
                    $t('default.back')
                }}
            </router-link>
        </div>
...
export default {
    ...
    methods: {
        getData: function () {
            ...
            app.model_id = id;
            axios.get('/api/v1/products_categories/' + id + '/get/')
                .then(function (resp) {
                    app.model = resp.data;
                    app.preloader = false;
                })
        ...
        saveForm(e) {
            ...
            axios.post('/api/v1/products_categories/' + app.model_id + '/update', newModel)
                .then(function (resp) {
